...
export default function SidebarBlurb() {
  return (
    <div className="mt-8 bg-[#151516] rounded-lg border border-red-900/40 p-4 text-xs text-left text-gray-400 shadow-inner font-medium">
      ...
      <div>
        <span className="font-bold text-white/90">In June 2025, Google forced ad blockers and privacy extensions to stop working on Chromium (the engine behind Chrome, Edge, and others).</span>
        <br /><br />
        Overnight, most people lost meaningful control over their private data and PII flowing from their browser - all in the name of ad revenue.
        <br /><br />
